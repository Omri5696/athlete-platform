...
הגרסה של `garminconnect` שעוקפת את החסימה של גרמין דורשת Python 3.12 ומעלה.
בדוק: `python3 --version`. אם זה 3.11 או פחות — התקן מ-[python.org](https://www.python.org/downloads/).
